...
#
# Generated by export_simulation on Fri Feb 23 16:14:27 +0100 2024
#
################################################################################
...
'-reset_run' switch to the './raw_data_fifo.sh' script.

./raw_data_fifo.sh -reset_run
...
./raw_data_fifo.sh -noclean_files

For more information on the script, please type './raw_data_fifo.sh -help'.
