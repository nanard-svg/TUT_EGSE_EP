...
set_property -dict {PACKAGE_PIN N4 IOSTANDARD LVCMOS33 DRIVE 8 SLEW SLOW} [get_ports {o_DAC_SYNC_n}]
set_property -dict {PACKAGE_PIN L5 IOSTANDARD LVCMOS33 DRIVE 8 SLEW SLOW} [get_ports {o_DAC_DIN}]
