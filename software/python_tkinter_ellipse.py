...
#b2 = Button(racine, text="DESTROY RACINE", command=racine.destroy) # bouton ratatché à la fenetre racine détruit la fenetre principale racine
#b2.pack()

#b3 = Button(racine, text="DESTROY BOUTON", command=b.destroy) # bouton ratatché à la fenetre racine détruit la bouton b
#b3.pack()

#b4 = Button(racine, text="b4", command=pathname1,name="b4") # bouton ratatché à la fenetre racine lance la fonction pathname1
#b4.pack()

b5 = Button(racine, text="RESET", command=Reset_unreset,name="b5") # BOUTON reset
b5.pack()

b6 = Button(racine, text="Injection", command=Injection,name="b5") # Injection reset
b6.pack()
...
#b6 = Button(racine, text="InitializeDevice", command=InitializeDevice,name="b6") # Bouton InitializeDevice
#b6.pack()

##################################### NEXT FEATURE ###############################################################
toplevel = Toplevel(racine, name="fenêtre2") # declare une nouvelle fenetre
toplevel.geometry("200x200+500+850") # taille de la nouvelle fenetre
toplevel.grid_propagate(0)
toplevel.title("fenetre toplevel")
#cadre = Frame(toplevel, width=50, height=50, bg="green")
#cadre.pack()
b = Button(toplevel, text="Reeds", bg="red", fg="black", name="b") # bouton sur la nouvelle fenetre
b.pack()
######################################################################################################################################
